...
- **地面站与传感器建模**：创建地面站、配置传感器视场和约束
- **轨道力学支持**：内置开普勒根数、笛卡尔坐标、TLE、时间格式解析
- **覆盖分析**：卫星覆盖定义、资产/地面站绑定、统计计算
- **星座生成**：Walker Delta 模式自动生成多卫星星座
- **报告系统**：快速报告 + Report_RM，支持 pandas DataFrame 导出
